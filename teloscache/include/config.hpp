...
// CACHE CONTRACT
#define NETWORK T //👋 update me ( must be upper case )
...
#define NATIVE_SYM symbol(symbol_code("TLOS"), 4) //👋 update me 
...
constexpr double PRECISIONFACTOR = 1e4; // 👋 update me ( core native token precision )